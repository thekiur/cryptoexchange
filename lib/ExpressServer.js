...
function Server(exchange) {
	...
	app.get('/whoami', function(req, res, next) {
		...
		exchange.wallet.getBalance(req.session.account, 'LTC', function(err, balance) {
			res.write('LTC balance: ' + balance + '\n');
			exchange.wallet.getUnconfirmedBalance(req.session.account, 'LTC', function(err, balance) {
				res.write('LTC unconfirmed balance: ' + balance + '\n');
				res.end();
			});
		});
	});
